...
import { getComplaints, getComplaintById, verifyComplaintHandler, createComplaint, upvoteComplaint, endorseComplaint, rateComplaint, addComment, facultyReopenComplaint, getEscalatedComplaints } from '../controllers/complaint.controller'
...
router.get('/escalated', authenticateUser, getEscalatedComplaints)
...
router.post('/:id/faculty-reopen', authenticateUser, requireRole('faculty'), facultyReopenComplaint)
